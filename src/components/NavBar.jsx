  ...
  return (
    <nav className="navbar navbar-expand-lg bg-body-tertiary shadow mb-3">
      <div className="container container-fluid">
        <span className="fs-4 me-4">Shopping Card</span>
        <button
        ...
        <div className="collapse navbar-collapse justify-content-between" id="navbarNavAltMarkup">
          ...
          >
            ...
            <div
              className="position-absolute bg-danger rounded-circle text-light"
              style={{bottom: "0", right: "0px", width: "20px", height: "20px", fontSize: "14px"}}
            >
              {cartItems.length}
            </div>
          </button>
